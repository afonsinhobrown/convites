...
export function MagnoliaOrganicaLayout({
  ...
  return (
    <div className="relative w-full max-w-md mx-auto aspect-[2/3]">
      <Image
        src="/templates/magnolia-organica/fundo.png"
        alt="Convite MagnÃ³lia OrgÃ¢nica"
        fill
        priority
...
<GuestNameOverlay guestName={data.guestName} mode={mode} />
      ...
      <div
        ...
        style={{ top: "24%", left: "48%", right: "3%", textAlign: "center", fontWeight: 700 }}
      >
        <AutoFitText
          text={data.brideName}
          maxFontSize={26}
      ...
      <div
        className="absolute z-10"
        style={{ top: "37%", left: "48%", right: "3%", textAlign: "center", fontWeight: 700 }}
      >
        <AutoFitText
          text={data.groomName}
          maxFontSize={26}
      ...
      <div className="absolute z-10" style={{ top: "60%", left: "52%", right: "5%" }}>
