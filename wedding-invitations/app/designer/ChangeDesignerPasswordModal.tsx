...
export function ChangeDesignerPasswordModal() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/designer/change-password", {
        method: "POST",
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            <div className="flex items-center justify-between pb-3 border-b border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-semibold text-gray-900">Alterar Senha de Designer</h3>
              </div>
              <button
                type="button"
            ...
            {success ? (
              <div className="my-6 flex flex-col items-center justify-center py-4 text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">A fechar janela...</p>
              </div>
            ) : (
